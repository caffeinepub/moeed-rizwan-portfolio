import { c as createLucideIcon, j as jsxRuntimeExports, r as reactExports, m as motion, C as Canvas, u as useThree, a as useFrame, B as BufferGeometry, b as BufferAttribute, d as BackSide } from "./index-BWMdIbXo.js";
import { u as useDeviceCapability } from "./useDeviceCapability-D32WBBoL.js";
import { E as ExternalLink } from "./external-link-DXnaSmOG.js";
/**
...
function IcosahedronWireframe({ isMobile }) {
  const meshRef = reactExports.useRef(null);
  const ring1Ref = reactExports.useRef(null);
  const ring2Ref = reactExports.useRef(null);
  const ring3Ref = reactExports.useRef(null);
  const ring4Ref = reactExports.useRef(null);
  useFrame((_, delta) => {
    if (meshRef.current) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("group", { position: [2.8, 0, 0], children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("pointLight", { color: "#00d4ff", intensity: 3, distance: 8 }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "pointLight",
      {
        color: "#f472b6",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("mesh", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("sphereGeometry", { args: [2.2, 32, 32] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "meshStandardMaterial",
        {
          color: "#00d4ff",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("mesh", { ref: meshRef, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("icosahedronGeometry", { args: [1.6, 1] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "meshStandardMaterial",
        {
          wireframe: true,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("mesh", { ref: ring1Ref, rotation: [Math.PI / 3, 0.3, 0], children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("torusGeometry", { args: [2.1, 0.015, 8, 100] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "meshStandardMaterial",
        {
          color: "#a855f7",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("mesh", { ref: ring2Ref, rotation: [0, 0.5, Math.PI / 4], children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("torusGeometry", { args: [2.4, 0.01, 8, 100] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "meshStandardMaterial",
        {
          color: "#fbbf24",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("mesh", { ref: ring3Ref, rotation: [Math.PI / 2, 0.2, 0.3], children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("torusGeometry", { args: [1.8, 0.012, 8, 100] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "meshStandardMaterial",
        {
          color: "#34d399",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("mesh", { ref: ring4Ref, rotation: [0.4, Math.PI / 3, 0.1], children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("torusGeometry", { args: [2.6, 8e-3, 8, 100] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "meshStandardMaterial",
        {
          color: "#f472b6",
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    Canvas,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(IcosahedronWireframe, { isMobile }),
